    ...
    <section className="mx-10 flex flex-col justify-center items-center">
      ...
      <div className="mb-12 grid grid-cols-2 gap-10">
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail1'} className="boxcard">
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail2'} className="boxcard">
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail3'} className="boxcard">
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail4'} className="boxcard">
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail5'} className="boxcard">
            <img src={portfolio}/>
            <div className="layercard">
              <div className="mt-2 w-[3.5rem] py-[0.170rem] rounded-md bg-white"></div>
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail6'} className="boxcard">
            <img src={portfolio}/>
            <div className="layercard">
              <div className="mt-2 w-[3.5rem] py-[0.170rem] rounded-md bg-white"></div>
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail7'} className="boxcard">
            <img src={portfolio}/>
            <div className="layercard">
              <div className="mt-2 w-[3.5rem] py-[0.170rem] rounded-md bg-white"></div>
        ...
        <div className="bg-blue-500 p-3 rounded-lg kontener">
          <Link to={'/portfoliodetail8'} className="boxcard">
            <img src={portfolio}/>
            <div className="layercard">
              <div className="mt-2 w-[3.5rem] py-[0.170rem] rounded-md bg-white"></div>
